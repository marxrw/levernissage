...
const SHOWS = [
  // --- EXISTING 8 ---
  {
    ...
    hood: "Griffintown", color: "#C8A882", reviewed: true, featured: false, between: false,
    ...
    address: "2020 rue William, Montréal, QC",
  },
  {
    ...
    hood: "Saint-Henri", color: "#8BAEC4", reviewed: true, featured: false, between: false,
    ...
    address: "3550 rue Saint-Antoine Ouest, Montréal, QC",
  },
  {
    ...
    hood: "Downtown", color: "#8DAA88", reviewed: false, featured: true, between: false,
    ...
    address: "372 rue Sainte-Catherine Ouest, Montréal, QC",
  },
  {
    ...
    hood: "Downtown", color: "#6A6058", reviewed: false, featured: true, between: false,
  ...
  },
  {
    ...
    hood: "Quartier des spectacles", color: "#B86040", reviewed: false, featured: true, between: false,
    desc: "Five artists consider the systems of care — emotional, domestic, civic — that make collective life possible.",
    address: "1201 rue Saint-Dominique, Montréal, QC",
  },
  {
    ...
    hood: "Mile-End", color: "#7888A0", reviewed: false, featured: true, between: false,
    ...
    address: "5420 boulevard Saint-Laurent, Montréal, QC",
  },
  {
  ...
  },
  {
    ...
    hood: "Mile-End", color: "#A89070", reviewed: false, featured: true, between: false,
    desc: "Cliche's sculptural practice excavates industrial materials, finding tenderness in concrete, rust, and reclaimed steel.",
    address: "1305 avenue des Pins Ouest, Montréal, QC",
  },
  // --- NEW MONTREAL GALLERIES ---
  {
    id: "duran", gallery: "Duran Contemporain", title: "How to Hold Hands", artist: "Holly MacKinnon",
    dates: "Mar 26 – Apr 18", openDate: "2026-03-26", closeDate: "2026-04-18",
    hood: "Downtown", color: "#B0A090", reviewed: false, featured: true, between: false,
    desc: "MacKinnon's paintings explore the quiet language of touch and proximity — gestures of care rendered in soft, luminous fields of colour.",
    address: "372 rue Sainte-Catherine Ouest, Montréal, QC",
  },
  {
    id: "nicolasrobert", gallery: "Galerie Nicolas Robert", title: "Chambres d'écho", artist: "Maude Corriveau",
    dates: "Mar – Apr 2026", openDate: "2026-03-01", closeDate: "2026-04-30",
    hood: "Griffintown", color: "#9AA8B0", reviewed: false, featured: true, between: false,
    desc: "Corriveau's practice investigates resonance and repetition — spaces where image and memory fold back on themselves.",
    address: "201 rue Bartlett, Montréal, QC",
  },
  {
    id: "chiguer", gallery: "Chiguer Art Contemporain", title: "Façades", artist: "Various Artists",
    dates: "Mar – Apr 2026", openDate: "2026-03-01", closeDate: "2026-04-30",
    hood: "Downtown", color: "#C0B8A8", reviewed: false, featured: false, between: false,
    desc: "An exhibition exploring the relationship between architectural surfaces and pictorial representation — what is presented as visible, and what lies beneath.",
    address: "372 rue Sainte-Catherine Ouest, Montréal, QC",
  },
  {
    id: "elikerr", gallery: "Galerie Eli Kerr", title: "Between Exhibitions", artist: "",
    dates: "", openDate: "2026-04-08", closeDate: "2026-04-08",
    hood: "Mile-End", color: "#D8D4CC", reviewed: false, featured: false, between: true,
    desc: "Galerie Eli Kerr is currently between exhibitions. The gallery represents an intergenerational program of artists working across sculpture, drawing, video, photography, and installation.",
    address: "4647 boulevard Saint-Laurent, Montréal, QC",
  },
  {
    id: "patrickmikhail", gallery: "Patrick Mikhail Gallery", title: "Between Exhibitions", artist: "",
    dates: "", openDate: "2026-04-08", closeDate: "2026-04-08",
    hood: "Mile-End", color: "#D8D4CC", reviewed: false, featured: false, between: true,
    desc: "Patrick Mikhail Gallery is currently between exhibitions. The gallery represents emerging and mid-career women artists working across painting, photography, installation, and new media.",
    address: "4815 boulevard Saint-Laurent, Montréal, QC",
  },
  {
    id: "robertsonares", gallery: "Galerie Robertson Arès", title: "Between Exhibitions", artist: "",
    dates: "", openDate: "2026-04-08", closeDate: "2026-04-08",
    hood: "Downtown", color: "#D8D4CC", reviewed: false, featured: false, between: true,
    desc: "Galerie Robertson Arès is currently between exhibitions. The gallery focuses on bold contemporary work by international and Canadian artists.",
    address: "1350 rue Sherbrooke Ouest, Montréal, QC",
  },
  {
    id: "robertpoulin", gallery: "Galerie Robert Poulin", title: "Between Exhibitions", artist: "",
    dates: "", openDate: "2026-04-08", closeDate: "2026-04-08",
    hood: "Mile-End", color: "#D8D4CC", reviewed: false, featured: false, between: true,
    desc: "Galerie Robert Poulin is currently between exhibitions. The gallery specializes in art brut, underground art, and narrative figuration.",
    address: "6341 boulevard Saint-Laurent, Montréal, QC",
  },
  {
    id: "patelbrownmtl", gallery: "Patel Brown", title: "Between Exhibitions", artist: "",
    dates: "", openDate: "2026-04-08", closeDate: "2026-04-08",
    hood: "Downtown", color: "#D8D4CC", reviewed: false, featured: false, between: true,
    desc: "Patel Brown's Montreal location is currently between exhibitions. The gallery represents emerging and established Canadian artists.",
    address: "372 rue Sainte-Catherine Ouest, Montréal, QC",
  },
  {
    id: "pfoac", gallery: "Pierre-François Ouellette art contemporain", title: "Between Exhibitions", artist: "",
    dates: "", openDate: "2026-04-08", closeDate: "2026-04-08",
    hood: "Plateau", color: "#D8D4CC", reviewed: false, featured: false, between: true,
    desc: "PFOAC is currently between exhibitions. One of Montreal's most respected galleries, located on Rachel Street near Parc La Fontaine.",
    address: "4402 boulevard Saint-Laurent, Montréal, QC",
  },
  {
    id: "tian", gallery: "TIAN Contemporain", title: "Between Exhibitions", artist: "",
    dates: "", openDate: "2026-04-08", closeDate: "2026-04-08",
    hood: "Downtown", color: "#D8D4CC", reviewed: false, featured: false, between: true,
    desc: "TIAN Contemporain is currently between exhibitions. The gallery presents contemporary art with a focus on emerging voices.",
    address: "372 rue Sainte-Catherine Ouest, Montréal, QC",
  },
  {
    id: "galcoa", gallery: "Galerie C.O.A", title: "Between Exhibitions", artist: "",
    dates: "", openDate: "2026-04-08", closeDate: "2026-04-08",
    hood: "Downtown", color: "#D8D4CC", reviewed: false, featured: false, between: true,
    desc: "Galerie C.O.A is currently between exhibitions. The gallery is a dynamic space in the Belgo Building presenting contemporary Quebec and Canadian art.",
    address: "372 rue Sainte-Catherine Ouest, Montréal, QC",
  },
  {
    id: "bellemarelambert", gallery: "Galeries Bellemare Lambert", title: "Between Exhibitions", artist: "",
    dates: "", openDate: "2026-04-08", closeDate: "2026-04-08",
    hood: "Downtown", color: "#D8D4CC", reviewed: false, featured: false, between: true,
    desc: "Galeries Bellemare Lambert is currently between exhibitions. The gallery presents historical modern and contemporary Quebec art.",
    address: "372 rue Sainte-Catherine Ouest, Montréal, QC",
  },
  {
    id: "yves", gallery: "Yves Laroche Galerie d'art", title: "Between Exhibitions", artist: "",
    dates: "", openDate: "2026-04-08", closeDate: "2026-04-08",
    hood: "Mile-End", color: "#D8D4CC", reviewed: false, featured: false, between: true,
    desc: "Yves Laroche Galerie d'art is currently between exhibitions. The gallery specializes in street art, pop art, and urban contemporary art.",
    address: "4 rue de Castelnau E, Montréal, QC",
  },
];
...
const T = {
  en: {
    ...
    closing:"Closing This Week", opening:"Opening This Week", nearby:"Nearby",
    mileEnd:"Mile-End", downtown:"Downtown", rosemont:"Rosemont",
    griffintown:"Griffintown", saintHenri:"Saint-Henri", plateau:"Plateau",
    ...
    addFromShows:"Star shows in the Exhibitions tab",
    locationDenied:"Location access denied. Please enable in settings.",
    gettingLocation:"Getting your location…",
    vernissageReview:"Vernissage Review",
    closingSoon:"Closing", openingSoon:"Opening", away:"away",
    loadingMap:"Placing pins…",
    betweenShows:"Between exhibitions",
  },
  fr: {
    ...
    closing:"Ferme cette semaine", opening:"Ouvre cette semaine", nearby:"À proximité",
    mileEnd:"Mile-End", downtown:"Centre-ville", rosemont:"Rosemont",
    griffintown:"Griffintown", saintHenri:"Saint-Henri", plateau:"Plateau",
    ...
    addFromShows:"Ajoutez des expositions depuis Expositions",
    ...
    loadingMap:"Placement des épingles…",
    betweenShows:"Entre expositions",
  }
};
...
async function geocode(address){
  try{
    ...
    const res=await fetch(url,{headers:{"User-Agent":"LeVernissage/1.0"}});
...
function pinSVG(featured){
  const shine=featured?"#6B8FFF":"#FF6B5A";
  const base=featured?BLUE:PIN_RED;
  return`<svg xmlns="http://www.w3.org/2000/svg" width="28" height="42" viewBox="0 0 28 42">
    <defs>
      <filter id="psh" x="-60%" y="-20%" width="220%" height="180%"><feDropShadow dx="0" dy="3" stdDeviation="2.5" flood-color="rgba(0,0,0,0.28)"/></filter>
      <radialGradient id="pg" cx="35%" cy="28%" r="65%"><stop offset="0%" stop-color="${shine}"/><stop offset="100%" stop-color="${base}"/></radialGradient>
    </defs>
    <ellipse cx="14" cy="40.5" rx="4.5" ry="1.5" fill="rgba(0,0,0,0.14)"/>
    <line x1="14" y1="15" x2="14" y2="38" stroke="#AAAAAA" stroke-width="1.3" stroke-linecap="round"/>
    <circle cx="14" cy="13" r="12" fill="url(#pg)" filter="url(#psh)"/>
    <circle cx="11" cy="10" r="4" fill="white" opacity="0.22"/>
    ${featured
      ?`<polyline points="8,13 12,17 20,9" fill="none" stroke="white" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" opacity="0.95"/>`
      :`<circle cx="14" cy="13" r="3.5" fill="white" opacity="0.80"/>`}
  </svg>`;
}
...
export default function App(){
  ...
  useEffect(()=>{
    if(tab!=="map"||Object.keys(coords).length>0||geocoding)return;
    setGeocoding(true);
    (async()=>{
      const results={};
  ...
  const filtered=SHOWS.filter(s=>{
    ...
    if(filter==="nearby"&&userLoc){
      ...
      if(!ca||!cb)return 0;
      return distanceKm(userLoc.lat,userLoc.lng,ca.lat,ca.lng)-distanceKm(userLoc.lat,userLoc.lng,cb.lat,cb.lng);
    }
    return 0;
  });

  function addMarker(L,map,s,c){
    const icon=L.divIcon({className:"",html:pinSVG(s.featured),iconSize:[28,42],iconAnchor:[14,42],popupAnchor:[0,-44]});
    const marker=L.marker([c.lat,c.lng],{icon}).addTo(map).bindPopup(`
      <div style="width:215px;font-family:'DM Sans',sans-serif;">
        ...
        <div style="padding:13px 15px 15px;">
          ...
          ${s.between
            ?`<div style="font-size:13px;color:${MID};font-style:italic;margin-bottom:8px;">Between exhibitions</div>`
            :`<div style="font-family:'Cormorant Garamond',serif;font-size:17px;font-style:italic;font-weight:600;color:${INK};line-height:1.2;margin-bottom:4px;">${s.title}</div>
              <div style="font-size:12px;color:${MID};margin-bottom:4px;">${s.artist}</div>`
          }
          <div style="font-size:11px;color:${MID};margin-bottom:12px;">${s.address.replace(", Montréal, QC","")}</div>
          <button onclick="window.__lvSelect('${s.id}')" style="width:100%;background:${INK};color:white;border:none;padding:10px;border-radius:3px;font-size:10px;letter-spacing:.10em;text-transform:uppercase;font-weight:700;cursor:pointer;font-family:'DM Sans',sans-serif;">View Gallery →</button>
        </div>
      </div>
  ...
  useEffect(()=>{
    if(!leafletMapRef.current||!window.L||Object.keys(coords).length===0)return;
    markersRef.current.forEach(m=>m.marker.remove());
    markersRef.current=[];
    const toShow=mapMode==="plan"?SHOWS.filter(s=>saved.has(s.id)):SHOWS;
    toShow.forEach(s=>{const c=coords[s.id];if(c)addMarker(window.L,leafletMapRef.current,s,c);});
  },[coords,saved,mapMode]);
  ...
  useEffect(()=>{
    ...
    const initMap=async()=>{
      ...
      L.tileLayer("https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png",{subdomains:"abcd",maxZoom:20,attribution:'© <a href="https://carto.com">CARTO</a> © <a href="https://openstreetmap.org">OSM</a>'}).addTo(map);
  ...
  const PinButton=({id,size=42})=>{
    ...
    return(
      <button onClick={e=>{e.stopPropagation();toggleSave(id);}} style={{width:size,height:size,borderRadius:4,border:`1.5px solid ${on?BLUE:BORDER}`,background:on?BLUE:WHITE,display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",flexShrink:0,transition:"all 0.15s"}}>
        <svg width="20" height="20" viewBox="0 0 24 24" fill={on?WHITE:"#C0BBB5"} xmlns="http://www.w3.org/2000/svg"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
      </button>
    );
  };
  ...
  const FILTERS=[
    ...
    ["rosemont",t.rosemont],["griffintown",t.griffintown],["saint-henri",t.saintHenri],["plateau",t.plateau],
  ];
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:WHITE,height:"100vh",display:"flex",flexDirection:"column",overflow:"hidden",maxWidth:430,margin:"0 auto",position:"relative",boxShadow:"0 0 60px rgba(0,0,0,0.08)"}}>
      ...
      <div style={{flex:1,overflow:"hidden",position:"relative",background:WHITE}}>
        ...
        {tab==="exhibitions"&&(
          <div style={{height:"100%",display:"flex",flexDirection:"column"}}>
            <div style={{background:WHITE,borderBottom:`1px solid ${BORDER}`,padding:"12px 0 12px 16px",flexShrink:0}}>
              <div style={{display:"flex",gap:8,overflowX:"auto",scrollbarWidth:"none",paddingRight:16}}>
                {FILTERS.map(([val,label])=>(
                  <button key={val} onClick={()=>setFilter(val)} style={{flexShrink:0,padding:"7px 15px",borderRadius:20,fontSize:12,letterSpacing:"0.06em",textTransform:"uppercase",fontWeight:500,border:`1.5px solid ${filter===val?BLUE:BORDER}`,background:filter===val?BLUE:WHITE,color:filter===val?WHITE:MID,cursor:"pointer",fontFamily:"'DM Sans',sans-serif",whiteSpace:"nowrap"}}>{label}</button>
                ))}
              </div>
            </div>
            ...
            <div style={{flex:1,overflowY:"auto"}}>
              {filtered.map(s=>{
                const c=coords[s.id];
                const dist=(userLoc&&c)?distanceKm(userLoc.lat,userLoc.lng,c.lat,c.lng):null;
                ...
                return(
                  <div key={s.id} onClick={()=>setDetail(s)} style={{position:"relative",cursor:"pointer",borderBottom:`1px solid ${BORDER}`}}>
                    <div style={{width:"100%",height:s.between?120:220,background:s.between?LIGHT:s.color,position:"relative",overflow:"hidden"}}>
                      ...
                      {s.featured&&!s.between&&(
                        <div style={{position:"absolute",top:12,left:12}}>
                          <svg width="22" height="22" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="12" fill={BLUE}/><polyline points="6,12 10,16 18,8" fill="none" stroke="white" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                        </div>
                      )}
                      {/* Badges */}
                      {!s.between&&(
                      ...
                      {/* Between exhibitions label */}
                      {s.between&&(
                        <div style={{height:"100%",display:"flex",alignItems:"center",padding:"0 20px"}}>
                          <div>
                            <div style={{fontSize:11,letterSpacing:"0.10em",textTransform:"uppercase",color:BLUE,fontWeight:700,marginBottom:6}}>{s.gallery}</div>
                            <div style={{fontSize:13,color:MID,fontStyle:"italic"}}>{t.betweenShows}</div>
                          </div>
                        </div>
                      )}
                      {/* Normal card text */}
        ...
        <div style={{display:tab==="map"?"flex":"none",flexDirection:"column",height:"100%",position:"relative"}}>
          <div style={{position:"absolute",top:14,left:"50%",transform:"translateX(-50%)",zIndex:1000,display:"flex",background:"rgba(255,255,255,0.82)",backdropFilter:"blur(8px)",border:`1px solid rgba(232,229,224,0.7)`,borderRadius:6,overflow:"hidden",boxShadow:"0 2px 10px rgba(0,0,0,0.08)"}}>
            {[["all",t.allShows],["plan",t.myPlan]].map(([mode,label])=>(
              <button key={mode} onClick={()=>setMapMode(mode)} style={{padding:"9px 20px",fontSize:11,letterSpacing:"0.08em",textTransform:"uppercase",fontWeight:700,background:mapMode===mode?BLUE:"transparent",color:mapMode===mode?WHITE:MID,border:"none",cursor:"pointer",fontFamily:"'DM Sans',sans-serif",transition:"all 0.15s"}}>{label}</button>
            ))}
          </div>
          {geocoding&&(
            <div style={{position:"absolute",bottom:20,left:"50%",transform:"translateX(-50%)",zIndex:999,background:"rgba(255,255,255,0.88)",backdropFilter:"blur(8px)",padding:"8px 18px",borderRadius:20,fontSize:12,color:MID,boxShadow:"0 2px 10px rgba(0,0,0,0.08)"}}>{t.loadingMap}</div>
          )}
            ...
            <div onClick={()=>setDetail(SHOWS[0])} style={{background:WHITE,borderBottom:`1px solid ${BORDER}`,cursor:"pointer",paddingBottom:20}}>
              ...
              <div style={{padding:"0 20px"}}>
                ...
                <div style={{fontSize:12,color:MID,display:"flex",alignItems:"center",gap:8}}>
                  <span>Sophie Tran</span><span style={{width:3,height:3,background:BORDER,borderRadius:"50%",display:"inline-block"}}/><span>April 8, 2026</span><span style={{width:3,height:3,background:BORDER,borderRadius:"50%",display:"inline-block"}}/><span>5 min read</span>
                </div>
              </div>
            </div>
      ...
      {detail&&(
        <div style={{position:"absolute",inset:0,background:WHITE,zIndex:50,overflowY:"auto",animation:"slideUp 0.32s cubic-bezier(0.16,1,0.3,1)"}}>
          ...
          <div style={{width:"100%",height:detail.between?160:260,background:detail.between?LIGHT:detail.color,display:"flex",alignItems:"center",justifyContent:detail.between?"center":"flex-start"}}>
            {detail.between&&<div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:22,fontStyle:"italic",color:MID}}>{t.betweenShows}</div>}
          </div>
