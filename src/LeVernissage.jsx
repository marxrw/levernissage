...
export default function App(){
  ...
  function addMarker(L,map,s){
    const icon=L.divIcon({className:"",html:pinSVG(s.featured),iconSize:[32,46],iconAnchor:[16,46],popupAnchor:[0,-48]});
