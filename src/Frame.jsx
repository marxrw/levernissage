...
function FeaturedCard({s,onClick,saved,onToggleSave,t,onFirstImageLoad}){
  ...
  return(
    ...
    <div style={{cursor:"pointer",position:"relative",height:FEATURED_CARD_HEIGHT,overflow:"hidden",background:CARD_PLACEHOLDER}}>
      ...
      <div style={{position:"absolute",bottom:0,left:0,right:0,background:"linear-gradient(to bottom, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0.7) 10%, rgba(255,255,255,0.8) 20%, rgba(255,255,255,0.85) 25%, rgba(255,255,255,0.9) 35%, rgba(255,255,255,0.95) 100%)",padding:"8px 12px 3px",zIndex:4,pointerEvents:"none"}}>
