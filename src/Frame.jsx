...
const T={
  en:{
    ...
    contactGallery:"Contact the venue",
  ...
  fr:{
    ...
    contactGallery:"Contacter le lieu",
  ...
  return (
    <div style={overlayStyle} onClick={handleDismiss}>
      <div style={sheetStyle} onClick={e => e.stopPropagation()}>
        ...
        {/* Instruction */}
        <div style={{fontFamily:"'DM Sans',sans-serif",fontSize:16,fontWeight:700,color:INK,padding:"0 24px",marginBottom:24,lineHeight:1.55}}>
          Follow these steps to add <span style={{fontFamily:"'Cormorant Garamond',serif",fontStyle:"italic",fontWeight:800,fontSize:19,color:INK,WebkitTextStroke:"0.4px currentColor"}}>Frame</span> to your home screen. It will look like any other app.
        </div>
  ...
  return(
    <div style={{position:"fixed",inset:0,background:WHITE,zIndex:2500,display:"flex",flexDirection:"column",maxWidth:430,margin:"0 auto",animation:"slideUp 0.28s cubic-bezier(0.16,1,0.3,1)",overflowY:"auto"}}>
      ...
      <div style={{borderTop:`1px solid ${BORDER}`}}>
        ...
        {show.website_url&&<a href={show.website_url} target="_blank" rel="noopener noreferrer" onClick={()=>capture("website_tapped",{gallery:show.gallery,source:"venue"})} style={{display:"flex",alignItems:"center",gap:14,padding:"18px 20px",borderBottom:`1px solid ${BORDER}`,textDecoration:"none",color:BLUE,fontSize:16,fontWeight:500}}>
        ...
        {show.instagram_url&&<a href={show.instagram_url} target="_blank" rel="noopener noreferrer" onClick={()=>capture("instagram_tapped",{gallery:show.gallery,source:"venue"})} style={{display:"flex",alignItems:"center",gap:14,padding:"18px 20px",borderBottom:`1px solid ${BORDER}`,textDecoration:"none",color:BLUE,fontSize:16,fontWeight:500}}>
