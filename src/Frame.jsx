...
function FeaturedCard({s,onClick,saved,onToggleSave,t,onFirstImageLoad}){
  ...
  return(
    ...
    <div style={{cursor:"pointer",position:"relative",height:FEATURED_CARD_HEIGHT,overflow:"hidden",background:CARD_PLACEHOLDER}}>
      ...
      <div style={{position:"absolute",bottom:0,left:0,right:0,background:"linear-gradient(to bottom, rgba(255,255,255,0) 0%, rgba(255,255,255,0.55) 35%, rgba(255,255,255,0.92) 100%)",padding:"22px 12px 6px",zIndex:4,pointerEvents:"none"}}>
