...
function FeaturedCard({s,onClick,saved,onToggleSave,t,onFirstImageLoad}){
  ...
  return(
    ...
    <div style={{cursor:"pointer",position:"relative",height:FEATURED_CARD_HEIGHT,overflow:"hidden",background:CARD_PLACEHOLDER}}>
      ...
      <div style={{position:"absolute",bottom:0,left:0,right:0,background:"linear-gradient(to bottom, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0.6) 10%, rgba(255,255,255,0.7) 20%, rgba(255,255,255,0.75) 25%, rgba(255,255,255,0.8) 35%, rgba(255,255,255,0.9) 100%)",padding:"20px 12px 7px",zIndex:4,pointerEvents:"none"}}>
